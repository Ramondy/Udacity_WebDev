...
def create_app(test_config=None):
    ...
    '''
    # CORS(app, resources={r"/api/*": {"origins": "*"}})  # which route ?
    CORS(app)
    ...
    def get_categories(return_type='json'):
        selection = Category.query.order_by(Category.id).all()
        categories = {item.format()['id']: item.format()['type'] for item in selection}
    ...
    def get_questions():
        categories = get_categories('dict')['categories']
